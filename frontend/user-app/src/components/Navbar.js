  ...
  const sections = [
    {
      ...
      links: [
        ...
        { label: "View Attendance", to: "/attendees" },
      ],
    },
    {
      name: "Premium Area",
    ...
    },
    {
      ...
      links: [
        ...
        { label: "Succesful Applicants", to: "/corp-awarded" },
  ...
  return (
    <nav className="bg-blue-600 text-white shadow-md">
      <div className="max-w-7xl mx-auto flex items-center justify-between px-6 py-3">
        {/*<h1 className="text-xl font-bold">Default</h1>*/}
        ...
        {isLoggedIn ? (
         ...
         <button
            ...
            className="bg-green-600 text-white rounded-full px-4 py-1.5 shadow hover:bg-gray-400 transition"
          >
            Register
          </button>
