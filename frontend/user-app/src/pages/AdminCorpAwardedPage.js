            ...
            <div className="sm:hidden space-y-4 mt-4">
              {pitches.map((p) => (
                <div
                  ...
                  ${p.location === "Main Ring & Corporate Area" ? "bg-red-200" : "bg-gray-300"}`}
                >
                  {/* Header */}
                  ...
                  {/* Date Used */} 
                  <div className="flex justify-between items-center mb-2">
                    <p className="text-md font-semibold text-gray-800 ">Date Last Used:  {p.last_day_used ? new Date(p.last_day_used).toLocaleDateString() : 'Not Used'}</p>
                  </div>
                  {/* Attendance Checkbox*/}
                  <div className="flex items-center space-x-2">  
                  <span className="text-lg font-semibold">Award Corporate Pitch:</span>  
